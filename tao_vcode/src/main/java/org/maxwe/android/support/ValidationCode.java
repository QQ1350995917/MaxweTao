package org.maxwe.android.support;
...
/**
 * Created by Pengwei Ding on 2017-03-01 21:27.
...
public class ValidationCode extends View {
    ...
    private void getAttrValues(Context context, AttributeSet attrs) {
        ...
        mTextSize = typedArray.getDimension(R.styleable.ValidationCode_CodeTextSize, 80);
