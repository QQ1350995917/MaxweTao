...
public class BrandActivity2 extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.promotionAdapter = new BaseAdapter() {
            private LayoutInflater inflater = LayoutInflater.from(BrandActivity2.this);
        ...
        this.positionAdapter = new BaseAdapter() {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                Position currentPP = SharedPreferencesUtils.getCurrentPP(BrandActivity2.this);
        ...
        this.lv_act_brand_promotion.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    childAt.setBackground(BrandActivity2.this.getResources().getDrawable(R.color.transparent));
                }
                view.setBackground(BrandActivity2.this.getResources().getDrawable(R.drawable.shape_rect_bg_shadow));
        ...
        this.lv_act_brand_position.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                SharedPreferencesUtils.saveCurrentPP(BrandActivity2.this, position1);
            }
        });
    ...
    private void getGuideList() {
        ...
        Callback.Cancelable cancelable = x.http().get(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ex.printStackTrace();
                Toast.makeText(BrandActivity2.this, "获取导购推广出错了", Toast.LENGTH_SHORT).show();
            }
    ...
    private void createGuide(final String name, String account, final String positionName) {
        ...
        Callback.Cancelable cancelable = x.http().post(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ex.printStackTrace();
                Toast.makeText(BrandActivity2.this, "创建导购推广出错了", Toast.LENGTH_SHORT).show();
            }
    ...
    private void getNewGuideInfo(final String newGuideName, final String positionName) {
        ...
        Callback.Cancelable cancelable = x.http().get(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ex.printStackTrace();
                Toast.makeText(BrandActivity2.this, "获取新建导购推广出错了", Toast.LENGTH_SHORT).show();
            }
    ...
    private void createADZone(String siteId, String positionName) {
        ...
        Callback.Cancelable cancelable = x.http().post(requestParams, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ex.printStackTrace();
                Toast.makeText(BrandActivity2.this, "创建导购推广位出错了", Toast.LENGTH_SHORT).show();
            }
